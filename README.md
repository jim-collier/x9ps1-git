...
But for good 'ol regular bash terminals. (Which is a bonus if you prefer Bash over Fish as a syntax and language. But Fish's suggestion/auto-completion functionality is admittedly really cool - though the `ble` project for Bash is arguably nearly as good if not better, taste-dependent.)
